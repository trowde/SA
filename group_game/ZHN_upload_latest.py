...
formula_extra=[pygame.transform.scale(formula,(SCREEN_WIDTH/NUMBER_OF_FORMULA,120)) for formula in formula_extra]
...
class Formula(pygame.sprite.Sprite):
    ...
    def formula_move(self):
        if self.formula_flag == 0:
            ...
            screen.blit(formula_render, (self.position_X+10, self.position_Y+65))
