...
class Other(pygame.sprite.Sprite):
    ...
    norm=0 
    @staticmethod
    def background_move(y):
        screen.blit(background,(0,y))
        screen.blit(background,(0,-1000+y))
...
formulas=[]
for i in range(4):
    formulas.append(Formula(i*125,-50,random.randint(1,10),Formula.operator[random.randint(0,3)]))
...
while running:
    ...
    Other.background_move(Other.background_position)
